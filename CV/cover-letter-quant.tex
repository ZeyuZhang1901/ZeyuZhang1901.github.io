...
data. Two companion papers extend the backtesting program to
mitigation---constrained RL post-training with convergence guarantees (under
review, NeurIPS 2026) and an inference-time auditing system evaluated on 2{,}769
forecasting instances, now accepted to the Findings of EMNLP 2026. I work daily in Python and PyTorch, build evaluation
