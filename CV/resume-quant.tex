...
\begin{bullets}
  ...
  \item \facet{Recover true forecasting skill.} Proved the inflation is \emph{non-identifiable} from
        ...
        score} with confidence intervals. Estimators track controlled contamination doses monotonically,
        localize real inflation at frontier models' cutoffs (GPT-4o pass@1 $0.534 \to 0.444$), and
        correctly shrink an apparent forecasting advantage to zero on 1{,}199 prediction-market questions
        (Polymarket, Metaculus, Manifold, INFER).
...
\begin{publist}
  \pub{Temporal Leakage in LLM Backtesting: From Statistical Modeling to Leakage-Adjusted Evaluation}
