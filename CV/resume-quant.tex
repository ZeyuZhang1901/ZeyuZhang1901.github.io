...
First-author publications at NeurIPS and EMNLP 2026 (Findings), two first-author papers under
review or in submission (NeurIPS 2026, TMLR), and an AISTATS 2026 Spotlight. Strong foundation in probability, statistics, optimization, and
...
\entry{LLM Backtesting \& Look-Ahead Bias: Theory, Detection, and Elimination}
  ...
  {Advisor: Prof.\ Bradly C.\ Stadie \quad Three first-author papers (Findings of EMNLP 2026; NeurIPS 2026 \& TMLR in submission)}{Sept 2025 -- Present}
\story{Backtesting is how every forecasting system is validated---and LLM forecasters, increasingly
  ...
  \textbf{look-ahead bias} that no date filter on the data can remove. Worse, the standard audit---%
  comparing performance before and after the training cutoff---is uninformative: legitimate recency
  reproduces the leakage pattern, flagging even provably clean models. My research treats this as one
  program: a \textbf{statistical theory} of what a backtest can reveal and how one defensible reference
  restores a corrected score, an \textbf{interpretable audit} and inference-time defense, and a
  \textbf{training method} that instills point-in-time discipline.}
\begin{bullets}
...
\begin{publist}
  \pub{Temporal Leakage in LLM Backtesting: Measurement, Validation, and Adjusted Scores}
    ...
    {\me, B.\ C.\ Stadie \; \href{https://arxiv.org/abs/2608.02985}{[arXiv:2608.02985]}
