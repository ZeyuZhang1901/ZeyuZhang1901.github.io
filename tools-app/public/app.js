...
class AcademicImageGenerator {
  ...
  async handleFiles(files) {
    ...
    for (const file of files) {
      ...
      this.elements.codeContent.value = currentCode + (currentCode ? "\n\n" : "") + `// === ${file.name} ===\n${content}`;
  ...
  updateProgress(step, text, percentage) {
    ...
    const stepElements = [this.elements.stepInterpret, this.elements.stepGenerate, this.elements.stepRefine, this.elements.stepReview];
  ...
  resetProgress() {
    ...
    [this.elements.stepInterpret, this.elements.stepGenerate, this.elements.stepRefine, this.elements.stepReview].forEach((el) => {
      el.classList.remove("active", "completed");
    });
  }
